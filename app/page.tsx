    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4 overflow-hidden relative">
      ...
      <div className={`relative z-10 max-w-6xl mx-auto transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {/* Players Card */}
          <Link href="https://padelyzer.com" className="group">
            <div className={`bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-3xl p-8 hover:border-green-500/50 hover:shadow-2xl hover:shadow-green-500/20 transition-all duration-500 hover:-translate-y-2 cursor-pointer h-full ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`} style={{transitionDelay: '200ms'}}>
              {/* Icon */}
          ...
          {/* Clubs Card */}
          <Link href="/web-club" className="group">
            <div className={`bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-3xl p-8 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/20 transition-all duration-500 hover:-translate-y-2 cursor-pointer h-full ${isLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`} style={{transitionDelay: '400ms'}}>
              {/* Icon */}
